...
std::unordered_map<int, std::unordered_multimap<int, std::vector<std::vector<int>>>> create_new_matrix(std::vector<std::vector<int>>& oldMatrix, std::vector<std::vector<int>>& newMatrix, const int& w, const int& h) {
